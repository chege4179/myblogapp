...
const SearchArticle = ({post}) => {
	...
	return (
		<div className=" rounded-xl overflow-hidden shadow-lg my-4 bg-white border-2 border-gray-300 border-solid hover:bg-gray-200">
			<Image width={740} height={300} className="w-full h-64" src={post.imageUrl}
