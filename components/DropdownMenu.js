...
const DropdownMenu = () => {
    ...
    return (
        <div className="absolute right-0 mt-2 mr-80 py-2 w-48 bg-white rounded-md shadow-xl z-20 sm:mr-32">
            ...
            <a href="#" onClick={LogOut} className="block px-4 py-2 text-sm capitalize text-gray-700 hover:bg-blue-500 hover:text-white">
                Sign Out
            </a>
        </div>
    );
